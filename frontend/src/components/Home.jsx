      ...
      <div className="container mx-auto px-4">
        <header className="flex flex-wrap items-center justify-between py-4">
          <div className="flex items-center space-x-2">
            <img src={logo} alt="EduNova" className="h-10 w-10 rounded-full" />
            <h1 className="text-2xl text-orange-500 font-bold">EduNova</h1>
          </div>
        ...
        <section className="text-center py-8">
          <h2 className="text-3xl font-bold text-orange-500">EduNova</h2>
          <p className="text-gray-300 mt-2">Sharpen your skills with courses crafted by experts.</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="flex flex-col items-center">
              ...
              <ul className="mt-4 text-gray-400 space-y-2">
                <li><a href="https://github.com/Divyansh031" className="hover:text-white flex items-center gap-1"><DiGithubBadge /> Divyansh031</a></li>
                <li><a href="https://www.linkedin.com/in/divyansh-sharma31/" className="hover:text-white flex items-center gap-1"><FaLinkedin /> divyansh-sharma31</a></li>
              </ul>
            </div>
            <div className="flex flex-col items-center">
              <h3 className="font-semibold">© 2025 EduNova</h3>
              <ul className="mt-4 text-gray-400 space-y-2">
